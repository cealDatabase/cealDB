...
export function SectionH2({
  ...
  return (
    <h2
      id={id}
      className="scroll-mt-24 text-3xl font-bold text-gray-900 mb-3 border-b-2 border-emerald-700 pb-2"
    >
      {lang === 'zh' ? zh : en}
    </h2>
  )
...
export function StepCard({
  ...
  return (
    <Card className="my-4 border-l-4 border-l-emerald-700">
      <CardHeader className="pb-2">
        <div className="flex items-center gap-3">
          <div className="flex-shrink-0 w-8 h-8 rounded-full bg-emerald-700 text-white flex items-center justify-center font-bold text-sm">
            {step}
          </div>
...
export function PageLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <a
      ...
      className="inline-flex items-center gap-1 text-emerald-700 underline hover:text-emerald-800 font-medium"
    >
      {children}
