...
import createLibraryAction from "./createAction";
...
const CreateLibraryForm = ({ data }: MyChildComponentProps) => {
  const [error, formAction] = useFormState(createLibraryAction, undefined);
  const [selectedDate, setSelectedDate] = useState<Dayjs | null>(null);
  // const [hideInLibraryListing, setHideInLibraryListing] =
  //   useState<Boolean>(false);
  // const handlehideInLibraryListingChange = (event: SelectChangeEvent) => {
  //   setHideInLibraryListing(event.target.value === "true");
  // };
    ...
    <main>
      ...
      <Container>
        <LocalizationProvider dateAdapter={AdapterDayjs}>
          <form className="bg-gray-100 rounded-lg pb-8" action={formAction}>
            ...
            <div className="space-y-12">
              ...
              <div className="mt-10 ">
                {/* Starting from Here*/}
                <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-3 mx-10">
                  {/* Library Name */}
                  ...
                  <Box className="col-span-1 mt-4">
                    <FormControl fullWidth>
                      <InputLabel>
                        Hide in library Listing?
                      </InputLabel>
                      <Select
                        labelId="hideInLibraryListing-label"
                        name="hideInLibraryListing"
                        label="HideInLibraryListing"
                      >
