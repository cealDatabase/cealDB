...
export default function SearchingDatabasePage() {
  const searchOptions = [
    ...
    {
      title: "Table View",
      description: "Search with year(s) and libraries, and view all data and fields available in individual tables",
      icon: Table,
      href: "/statistics/tableview",
    },
    {
      title: "Graph View",
      description: "Search and view the data available as customizable graphs",
      icon: BarChart3,
