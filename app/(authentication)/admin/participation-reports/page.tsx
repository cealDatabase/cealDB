...
import ParticipationReportsClient from './ParticipationReportsClient';

export default async function ParticipationReportsPage() {
  ...
  return <ParticipationReportsClient />;
}
