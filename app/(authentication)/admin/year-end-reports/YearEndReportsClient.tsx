...
import { FileSpreadsheet, FileText, Download, Loader2, CheckCircle2, SlashIcon } from 'lucide-react';
...
export default function YearEndReportsClient() {
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>Year-End Reports</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
