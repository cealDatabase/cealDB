                ...
                {pastYearsData.map((yearData, index) => {
                  ...
                  return (
                    <tr key={yearData.year} className={(index % 2 === 0 ? 'bg-white' : 'bg-gray-50') + ' hover:bg-yellow-100'}>
                      ...
                      {/* TITLES Total (Purchased + Non-Purchased only, Subscription excluded) */}
                      <td className="border px-1 text-right bg-green-100 font-bold">
                        {f(d?.ebooks_purchased_titles_subtotal) + f(d?.ebooks_nonpurchased_titles_subtotal)}
                      </td>
                      ...
                      {/* VOLUMES Total (Purchased + Non-Purchased only, Subscription excluded) */}
                      <td className="border px-1 text-right bg-green-100 font-bold">
                        {f(d?.ebooks_purchased_volumes_subtotal) + f(d?.ebooks_nonpurchased_volumes_subtotal)}
                      </td>
                    </tr>
                  )
                })}
