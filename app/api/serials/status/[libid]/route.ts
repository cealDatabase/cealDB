// /app/api/serials/status/[libid]/route.ts
...
export async function GET(
  ...
  try {
    ...
    // Get existing serials data
    const existingData = await db.serials.findFirst({
      where: {
    ...
    console.error("API error (check library year status):", error);
