    ...
    if (finalSubmit) {
      ...
      if (hasValidData) {
        ...
        await db.entry_Status.upsert({
          ...
          update: { unprocessed_backlog_materials: false },
          create: { libraryyear: libraryYear.id, unprocessed_backlog_materials: false },
        });
