...
import { CheckCircle, Info, Calculator, Gift } from "lucide-react"
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-primary text-base">Purchased Items</CardTitle>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1 text-xs">
                  ...
                  <div className="flex justify-between items-center py-1 border-t border-border mt-2 pt-2">
                    <span className="font-medium text-xs">Subtotal</span>
                    <Badge className="bg-blue-100/90 text-blue-500 text-xs">Auto Calculated: 06+07+08+09</Badge>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-base">Non-Purchased Items</CardTitle>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1 text-xs">
                  ...
                  <div className="flex justify-between items-center py-1 border-t border-border mt-2 pt-2">
                    <span className="font-medium text-xs">Subtotal</span>
                    <Badge className="bg-blue-100/90 text-blue-500 text-xs">Auto Calculated: 11+12+13+14</Badge>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1 text-xs">
                  ...
                  <div className="flex justify-between items-center py-1 border-t border-border mt-2 pt-2">
                    <span className="font-medium text-xs">Subtotal</span>
                    <Badge className="bg-blue-100/90 text-blue-500 text-xs">Auto Calculated: 16+17+18+19</Badge>
                  </div>
                </div>
              </div>
            </CardContent>
