...
export interface AuditLogData {
  userId?: number;
  username?: string;
  action: 'CREATE' | 'UPDATE' | 'DELETE' | 'SIGNIN' | 'SIGNOUT' | 'SIGNIN_FAILED' | 'UPDATE_ROLES' | 'SYSTEM_OPEN_FORMS' | 'SYSTEM_CLOSE_FORMS' | 'POST_COLLECTION_EDIT' | 'IMPORT' | 'TEST_OPEN_FORMS' | 'TEST_CLOSE_FORMS' | 'EXPORT' | 'FORM_SUBMIT' | 'FORM_DRAFT' | 'COOKIE_CONSENT';
  tableName?: string;
